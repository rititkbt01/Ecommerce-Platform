...
<div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <!-- Submit Button -->
                <button type="submit" class="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 font-bold">
                    Login
                </button>
            </form>
            ...
            <a href="{{ route('google.redirect') }}" 
               class="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 font-semibold transition">
